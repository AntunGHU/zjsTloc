...
a = people.sort();
console.log(a)  // ["Angie", "Jolene", "Maggie May", "Mrs. Robsinson", "Roxanne"]

let nums = [34, 10, 100000, 67, 99];

b = nums.sort();
console.log(b)  //[10, 100000, 34, 67, 99]
...
// sortira inplace, prvo pretvara u string!?!?! pa zato sortiranje brojeva ne ide kako treba!!!